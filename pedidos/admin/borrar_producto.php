...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    {
      $conn = conectar();   
      $cdquery="SELECT p.productoid, p.nombre, c.Nombre as descripcion from producto p inner join categoria c on p.categoriaid = c.categoriaid where productoid = " . $_GET["productoid"] . ";";
        ...
        <div class="box-body">
          <form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="textarea" value="<?php echo $cat; ?>" name="aclaracion" id="descripcion" placeholder="Ingrese una aclracion..."  disabled/>
            </div>            

            <div class="box-footer clearfix">
              <input type="submit" style="display:none;" id="btnSubmit" name="submit" value="Borrar Producto" />
              <input type="button" class="btn btn-sm btn-info btn-flat pull-left" id="btnBorrar" value="Borrar Producto" onclick="confirmDelete();" /> 
      ...
      <script>
        function confirmDelete() {
          if (confirm("El producto sera borrado definitivamente. Esta de acuerdo?")) {
            $("#btnSubmit").click();
          }
        }
      </script>
