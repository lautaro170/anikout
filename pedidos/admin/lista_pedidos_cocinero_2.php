...
<section class="content">
   ...
   <div class="box box-info">
    ...
    <tbody>  
        ...
        $conn =conectar();
        $today = date("Y-m-d");
        $fechaEntregaActual = getFechaEntrega($today);
        ...
        WHERE p.fecha_entrega = '2023-06-09'  
        GROUP BY pr.productoid, p.fecha_entrega ORDER BY fecha_entrega, pr.cocineroid, pr.categoriaid,pr.nombre;";
