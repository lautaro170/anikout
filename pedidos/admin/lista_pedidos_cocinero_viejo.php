...
<section class="content">
   ...
   <div class="box box-info">
    ...
    <tbody>  
        ...
        $conn =conectar();
        $today = date("Y-m-d");
        $sql = "SELECT pr.productoid, pr.nombre, SUM(pp.chico) as chico, SUM(pp.mediano) as mediano, SUM(pp.grande) as grande, SUM(pp.cantidad) as cantidad, u.Nombre as cook, u.UsuarioId as cookid, p.fecha_entrega as fecha , pr.categoriaid as catid FROM pedido p 
        ...
        group by fecha_entrega, pr.productoid order by fecha, pr.cocineroid, pr.categoriaid,pr.nombre;";
