...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Zona envío</a></li>
        ...
        <div class="box-body">
          <form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="form-horizontal">
            ...
            <div class="box-footer clearfix">
              ...
              <input type="button" class="btn btn-sm btn-info btn-flat pull-left" id="btnBorrar" value="Borrar Zona Envío" onclick="confirmDelete();" /> 
