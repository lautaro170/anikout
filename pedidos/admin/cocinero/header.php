                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                      ...
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><?php echo $_SESSION['nombrecompleto_ac']; ?></span>
                      </a>
                      <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                          ...
                          ?>
                          <p>
                            <?php echo $_SESSION['nombrecompleto_ac']; ?> - Administrador                      
                          </p>
                ...
                <a href="#">
                  <div class="user-panel">
                    ...
                    <div class="pull-left info">
                      <p><?php echo $_SESSION['nombrecompleto_ac']; ?></p>
                      <!-- Status -->
                ...
                <ul class="sidebar-menu">
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">                     
                      <li><a href="index.php"><i class="fa fa-circle-o"></i>Listado</a></li>
                      <!-- <li><a href="lista_pedidos_historico.php"><i class="fa fa-circle-o"></i>Listado Historico</a></li>-->
                    </ul>
                  </li>                
                  <li class="treeview">
                    <a href="#"><i class="fa fa-exchange"></i> <span>Productos</span> <i class="fa fa-angle-right pull-right"></i></a>
                    <ul class="treeview-menu">                     
                      <li><a href="productosactivos.php"><i class="fa fa-circle-o"></i>Activos</a></li>
                      <!-- <li><a href="lista_pedidos_historico.php"><i class="fa fa-circle-o"></i>Listado Historico</a></li>-->
                    </ul>
                  </li>                
